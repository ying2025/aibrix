...
type Interface interface {
	// RayClusterFleets returns a RayClusterFleetInformer.
...
// RayClusterFleets returns a RayClusterFleetInformer.
func (v *version) RayClusterFleets() RayClusterFleetInformer {
	return &rayClusterFleetInformer{factory: v.factory, namespace: v.namespace, tweakListOptions: v.tweakListOptions}
}
