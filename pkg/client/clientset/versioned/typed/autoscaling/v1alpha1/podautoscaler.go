...
type PodAutoscalerInterface interface {
	...
	Apply(ctx context.Context, podAutoscaler *autoscalingv1alpha1.PodAutoscalerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PodAutoscaler, err error)
	ApplyStatus(ctx context.Context, podAutoscaler *autoscalingv1alpha1.PodAutoscalerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PodAutoscaler, err error)
...
// Apply takes the given apply declarative configuration, applies it and returns the applied podAutoscaler.
func (c *podAutoscalers) Apply(ctx context.Context, podAutoscaler *autoscalingv1alpha1.PodAutoscalerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PodAutoscaler, err error) {
	if podAutoscaler == nil {
		return nil, fmt.Errorf("podAutoscaler provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
	data, err := json.Marshal(podAutoscaler)
	if err != nil {
		return nil, err
	}
	name := podAutoscaler.Name
	if name == nil {
		return nil, fmt.Errorf("podAutoscaler.Name must be provided to Apply")
	}
	result = &v1alpha1.PodAutoscaler{}
...
func (c *podAutoscalers) ApplyStatus(ctx context.Context, podAutoscaler *autoscalingv1alpha1.PodAutoscalerApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.PodAutoscaler, err error) {
	if podAutoscaler == nil {
		return nil, fmt.Errorf("podAutoscaler provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
